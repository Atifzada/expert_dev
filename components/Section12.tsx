        ...
        <section className="m-20">
            <div className="mx-24 py-12 flex flex-col gap-2 items-center bg-black rounded-[100px]"style={{ borderBottomLeftRadius: "0" }}>
                ...
                <div className="form mt-8">
                    <form action="/#wpcf7-f33869-p33807-o1" method="post" className="w-full" aria-label="Kontaktní formulář" noValidate="novalidate" data-status="init">
                        <div className="m--2 grid grid-cols-1 md:grid-cols-2 gap-8   ">
                            <div>
                                
                                <input size="60" className="w-full bg-white rounded-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white" aria-required="true" aria-invalid="false" placeholder="Jméno*" value="" type="text" name="your-name" style={{ borderBottomLeftRadius: "0" }} />
                            </div>
                            <div>
                               
                                <input size="60" className="w-full bg-white rounded-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white" aria-required="true" aria-invalid="false" placeholder="Telefon*" value="" type="tel" name="phone" style={{ borderBottomLeftRadius: "0" }} />
                            </div>
                        
                            <div className="">

                                <input size="60" className="w-full bg-white rounded-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white" aria-required="true" aria-invalid="false" placeholder="E-mail*" value="" type="email" name="your-email" style={{ borderBottomLeftRadius: "0" }} />
                            </div>
                        ...
                        <div className="mt-4 flex justify-center">
                            <div className="bg-custom-red flex items-center rounded-full px-4">
                                <button type="submit" className="text-white text-18 font-nornal font-QuickSand p-2 rounded-full" style={{ borderBottomLeftRadius: "0", marginRight: "10px" }}>
