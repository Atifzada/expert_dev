...
const Section4 = () => {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-between w-full gap-4 px-4 lg:px-20 large:px-28 py-10 my-16">
      ...
      {/* Right container */}
      <div className="flex flex-col items-center lg:items-start lg:w-[50%] lg:gap-6 gap-4">
        ...
        <h2 className="text-40 font-Balooc font-extrabold text-black text-center lg:text-left">
          Specialisté na digitální marketing
        </h2>
        <p className="text-16 font-medium font-QuickSand text-black text-center lg:text-left">
        ...
        <div className="flex flex-col large:flex-row items-center justify-between lg:items-start large:items-center w-full large:w-[80%] fourK:w-[60%] gap-2">
          <div className="flex items-center justify-around gap-4 large:w-[40%] fourK:w-[60%] bg-custom-red rounded-full p-2 text-white font-medium font-QuickSand" style={{ borderBottomLeftRadius: "0" }}>
            <p className="text-center text-16">Více o Expert Dev</p>
            <FaArrowAltCircleRight className="text-20" />
          </div>
          <div className="flex items-center justify-center lg:justify-start gap-4 w-full large:w-[60%] fourK:w-[40%] text-pink font-semibold font-QuickSand p-2">
            <BsChatDots className="text-28" />
            <p className="text-16">Konzultace zdarma</p>
          </div>
        </div>
      </div>
    </section>
